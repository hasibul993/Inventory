package com.inventory.Database;//add your package name here example: package com.example.dbm;
...
public class AndroidDatabaseViewer extends AppCompatActivity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //in the below line Change the text 'yourCustomSqlHelper' with your custom sqlitehelper class name
        dbm = new DatabaseHelper(AndroidDatabaseViewer.this);

        mainscrollview = new ScrollView(AndroidDatabaseViewer.this);
        ...
        mainLayout = new LinearLayout(AndroidDatabaseViewer.this);
        ...
        TextView secondrowtext = new TextView(AndroidDatabaseViewer.this);
        secondrowtext.setText("No. Of Records : ");
        secondrowtext.setTextSize(20);
        secondrowtext.setLayoutParams(secondrowlp);
        tv = new TextView(AndroidDatabaseViewer.this);
        tv.setTextSize(20);
        ...
        final Button submitQuery = new Button(AndroidDatabaseViewer.this);
        ...
        final TextView help = new TextView(AndroidDatabaseViewer.this);
        help.setText("Click on the row below to update values or deleteIcon the tuple");
        help.setPadding(0, 5, 0, 5);

        // the spinner which gives user a option to add new row , drop or deleteIcon table
        final Spinner spinnertable = new Spinner(AndroidDatabaseViewer.this);
        ...
        final LinearLayout thirdrow = new LinearLayout(AndroidDatabaseViewer.this);
        previous = new Button(AndroidDatabaseViewer.this);
        previous.setText("Previous");

        previous.setBackgroundColor(Color.parseColor("#BAE7F6"));
        previous.setLayoutParams(secondrowlp);
        next = new Button(AndroidDatabaseViewer.this);
        next.setText("UpdateBackend");
        ...
        tvmessage = new TextView(AndroidDatabaseViewer.this);
        ...
        final Button customQuery = new Button(AndroidDatabaseViewer.this);
        ...
        ArrayAdapter<String> tablenamesadapter = new ArrayAdapter<String>(AndroidDatabaseViewer.this,
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if (pos != 0) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(AndroidDatabaseViewer.this,
                    ...
                    if (c2 != null) {
                        ...
                        //the spinnertable has the 3 items to drop , deleteIcon , add row to the table selected by the user
                        ...
                        spinnertable.setOnItemSelectedListener((new OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            if (!isFinishing()) {
                                                ...
                                                new AlertDialog.Builder(AndroidDatabaseViewer.this)
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            if (!isFinishing()) {
                                                ...
                                                new AlertDialog.Builder(AndroidDatabaseViewer.this)
                                                        .setTitle("Are you sure?")
                                                        .setMessage("Clicking on yes will deleteIcon all the contents of " + indexInfo.table_name + " table from database")
                                                        .setPositiveButton("yes",
                                                                new DialogInterface.OnClickListener() {

                                                                    // when user confirms by clicking on yes we drop the table by executing deleteIcon table query
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        String Query7 = "Delete  from " + indexInfo.table_name;
                                                                        Log.d("deleteIcon table query", Query7);
                                ...
                                if (spinnertable.getSelectedItem().toString().equals("Add row to this table")) {
                                    ...
                                    final ScrollView addrowsv = new ScrollView(AndroidDatabaseViewer.this);
                                    ...
                                    final RelativeLayout addnewlayout = new RelativeLayout(AndroidDatabaseViewer.this);
                                    ...
                                    for (int i = 0; i < addnewrownames.size(); i++) {
                                        ...
                                        et.setId(k);
                                        final LinearLayout ll = new LinearLayout(AndroidDatabaseViewer.this);
                        ...
                        for (int k = 0; k < c2.getColumnCount(); k++) {
                            LinearLayout cell = new LinearLayout(AndroidDatabaseViewer.this);
    ...
    //displays alert dialog from which use can update or deleteIcon a row
    public void updateDeletePopup(int row) {
        Cursor c2 = indexInfo.maincursor;
        // a spinner which gives options to update or deleteIcon the row which user has selected
        ...
        final RelativeLayout lp = new RelativeLayout(AndroidDatabaseViewer.this);
        lp.setBackgroundColor(Color.WHITE);
        RelativeLayout.LayoutParams lay = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        lay.addRule(RelativeLayout.ALIGN_PARENT_TOP);

        final ScrollView updaterowsv = new ScrollView(AndroidDatabaseViewer.this);
        LinearLayout lcrud = new LinearLayout(AndroidDatabaseViewer.this);
        ...
        //spinner which displays update , deleteIcon options
        final Spinner crud_dropdown = new Spinner(getApplicationContext());

        ArrayAdapter<String> crudadapter = new ArrayAdapter<String>(AndroidDatabaseViewer.this,
                            ...
                            .setPositiveButton("Ok",
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            //it he spinner value is deleteIcon this row get the values from
                                            //edit text fields generate a deleteIcon query and execute it
    ...
    public void paginatetable(final int number) {
        ...
        do {
            ...
            //from where user can update or deleteIcon the row
    ...
    public static void GotoAndroidDatabaseViewer(Context context) {
        try {
            Intent intent = new Intent(context, AndroidDatabaseViewer.class);
