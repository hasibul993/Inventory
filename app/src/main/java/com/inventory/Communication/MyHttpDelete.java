...
public class MyHttpDelete extends AsyncTask<String, Integer, String> {
    private MyHttpPutListener listener;
    public String url = null;
    public String deleteData = "";
    public final String TAG = "HTTP_DELETE - ";
    public boolean flag;
    Context context;


    public MyHttpDelete(MyHttpPutListener listener, Context context) {
        this.listener = listener;
        this.context = context;
    }

    public MyHttpDelete(MyHttpPutListener listener, boolean flag, Context context) {
        this.listener = listener;
        this.flag = flag;
        this.context = context;
    }
...
// httppost.setHeader("Content-type", "application/json");
            ...
            if (deleteData.length() > 1) {
                ...
                StringEntity se = new StringEntity(deleteData);
